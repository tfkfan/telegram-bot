...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCHQUERY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SEARCHQUERY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SEARCHQUERY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SEARCHQUERY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SEARCHQUERY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SEARCHQUERY actions', async () => {
      const arg = 42666;
