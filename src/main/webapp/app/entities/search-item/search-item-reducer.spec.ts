...
import reducer, { getEntities, getEntity, reset } from './search-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCHITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SEARCHITEM actions', async () => {
      const arg = 42666;
