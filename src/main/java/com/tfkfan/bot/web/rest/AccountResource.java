...
import com.tfkfan.bot.service.InvalidPasswordException;
import com.tfkfan.bot.service.MailService;
import com.tfkfan.bot.service.UserService;
import com.tfkfan.bot.service.UsernameAlreadyUsedException;
import com.tfkfan.bot.service.dto.PasswordChangeDTO;
import com.tfkfan.bot.service.dto.UserDTO;
import com.tfkfan.bot.web.rest.errors.EmailAlreadyUsedException;
import com.tfkfan.bot.web.rest.errors.InvalidPasswordWebException;
import com.tfkfan.bot.web.rest.errors.LoginAlreadyUsedException;
import com.tfkfan.bot.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.tfkfan.bot.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
